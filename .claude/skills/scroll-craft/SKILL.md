---
name: scroll-craft
description: "Build a premium scroll driven landing page where scroll is the timeline: video scrubs under the wheel, sections pin and advance, headlines assemble line by line. Interviews the human first, picks a page grammar and a signature move so no two builds share a skeleton, writes real semantic HTML, then verifies by screenshotting its own scroll. Use for scrollytelling, Apple style, or experience pages."
