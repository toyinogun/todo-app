...
| "scrollytelling", scroll scrubbed video, a page that should feel like an experience, or the spec names `scroll-craft` | **UI** → `ui-guide.md` case 5 (`scroll-craft` handoff) |
